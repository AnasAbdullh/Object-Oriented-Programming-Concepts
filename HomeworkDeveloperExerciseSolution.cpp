...
public :
    ...
    clsDeveloper (int ID,string FisrtName,string LastName,string Email,string Phone,string title,string Deparment,double Salary,string MainProgrammingLanguage)
        : clsEmployee(ID,FisrtName,LastName,Email,Phone,title,Deparment,Salary) {
    ...
    void Print() {
        ...
        clsEmployee::Print();
        cout << _MainProgrammingLanguage << endl;
    }
...
int main()
{
    ...
    clsDeveloper  Developer(30,"Anas","Abdallah","Anas@gma","774762326","Aden","CS",20000,"c++");
    Developer.Print();
